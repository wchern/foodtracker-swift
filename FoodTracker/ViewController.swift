...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate, UISearchControllerDelegate, UISearchResultsUpdating {
    ...
    // Nutritionix API
    let kAppId = "6edbe78c"
    let kAppKey = "021ae5e13ad41c58a57bc5b0edb8322f"
    ...
    var scopeButtonTitles = ["Suggested", "Search Results", "Saved"]
    ...
    override func viewDidLoad() {
        ...
        self.suggestedSearchFoods = ["apple", "bagel", "banana", "bread", "carrots", "cheddar cheese", "chicken breast", "chili with beans", "chocolate chip cookie", "coffee", "cola", "corn", "egg", "graham cracker", "granola bar", "green beans", "ground beef patty", "hot dog", "ice cream", "jelly doughnut", "ketchup", "milk", "mixed nuts", "mustard", "oatmeal", "orange juice", "peanut butter", "pizza", "pork chops", "potato", "potato chips", "pretzel", "raisins", "ranch salad dressing", "rice", "salsa", "shrimp", "spaghetti", "spaghetti sauce", "tuna", "yellow cake"]
        ...
        var task = session.dataTaskWithRequest(request, completionHandler: { (data, response, err) -> Void in
            ...
            if conversionError != nil {
                ...
                if jsonDictionary != nil {
                    ...
                    let errorString = NSString(data: data, encoding: NSUTF8StringEncoding)
                    println("Error - Unable to parse JSON \(errorString)")
                }
            }
        })
